...
SAP Browser Automation is an AI web automation Chrome extension that runs multi-agent systems locally in the browser. It supports multiple LLM providers (OpenAI, Anthropic, Gemini, Ollama, OpenRouter, etc.).
